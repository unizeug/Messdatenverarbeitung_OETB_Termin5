...
\begin{quote}
    ...
    \begin{quote}
    	...
    	Das Ergebnis der Messungen von zwei Rechtecksignalen, einmal mit $3kHz$ und
    	einmal mit $15kHz$ Abtastfrequenz, sind hier zu sehen:
    	 ...
    	 \begin{center}
                ...
                \hspace{-12em}
                    \begin{minipage}{0.6\textwidth}
                        ...
                        \begin{figure}[H]
                            \label{fig:}
                            \includegraphics[scale=0.6, trim = 3cm 9cm 3cm
                            8.5cm, clip]{./Bilder/6_2_rechteck3kHz}
                            %FIXME [width=640px,
                             %height=474px]
