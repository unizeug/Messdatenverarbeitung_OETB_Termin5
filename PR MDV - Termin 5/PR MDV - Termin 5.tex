    ...
    \begin{quote}
    	...
    	\begin{quote}
		  ...
		  \begin{quote}
		    ...
		    die passenden Filterkoeffizienten ausgeben lassen, die Impulsantwort dieses Filters mit Hilfe der Funktion
		    ``FIRFilterung'' ausgeben lassen, den Amplituden und Phasengang ausgeben lassen und kontrolliert, ob das Filter
		    mit der angegebenen Ordnung die Vorgaben erfüllt. Falls nicht haben wir so lange die Filterordnung oder die
		    Fensterung verändert, bis die Vorgaben erfüllt waren.\\
